"""
Módulo con datos de ejemplo para la red social.
Contiene las funciones para crear y gestionar datos iniciales.
"""
...
def crear_red_ejemplo():
    ...
    Returns:
        RedSocial: Red social inicializada con usuarios y conexiones
    """
    red = RedSocial()
